...
if(mysqli_num_rows($result)>0){
    ...
    while($row=mysqli_fetch_assoc($result)){
            ...
            echo "<td><a href='update.php?user_id=$row[user_id]&username=$row[username]&password=$row[password]&mobile=$row[mobile]' class='btn btn-warning ml-3'>Edit</td>";
            echo "<td><a href='delete.php?user_id=".$row["user_id"]."' class='btn btn-danger ml-3'>Delete</td>";
            echo "</tr>";
    }
}
else
